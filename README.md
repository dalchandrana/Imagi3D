...
![Imagi3D](.github/assets/demo.png)
...
| Package | Description |
|---------|-------------|
| [`packages/engine`](packages/engine/) | Embeddable `<SVG3D>` React component — published to npm as [`imagi3d`](https://www.npmjs.com/package/imagi3d) |
| [`packages/web`](packages/web/) | Visual editor at [imagi3d.design](https://imagi3d.design) — design 3D objects and export as images, video, 3D models, or embed code |
...
MIT — [dalchandrana](https://github.com/dalchandrana)

Made in [Antigravity](https://antigravity.google) 🫐
