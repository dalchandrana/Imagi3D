...
Imagi3D is a monorepo with two packages:

- **`packages/engine`** — `<SVG3D>` React component published to npm as `imagi3d`
- **`packages/web`** — Next.js visual editor at imagi3d.design
...
- Web imports engine as a workspace dependency (`"imagi3d": "file:../engine"`)
