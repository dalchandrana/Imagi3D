...
export default function Home() {
  ...
  const [currentText, setCurrentText] = useState("Imagi3D");
  ...
  const handle3DExport = useCallback((format: Export3DFormat) => {
    const base = inputTab === "text" && currentText ? currentText.replace(/[^a-z0-9]+/gi, "-").toLowerCase() || "imagi3d" : "imagi3d";
  ...
  return (
    <main className="fixed inset-0 w-screen h-[100svh] overflow-hidden bg-background">
      {/* Layer 0: 3D Canvas */}
