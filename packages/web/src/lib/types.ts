 ...
 *
 * Material types come from the engine ("imagi3d").
 * Texture and light settings are web-editor-specific.
 */

// Re-export engine types so existing imports from "@/lib/types" still work
export type { MaterialSettings, MaterialPreset } from "imagi3d";
export { materialPresets } from "imagi3d";
import { materialPresets } from "imagi3d";
