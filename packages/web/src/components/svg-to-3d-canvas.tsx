 ...
 * =============================================================================
 *
 * Web editor wrapper around the imagi3d engine's <SVG3D> component. Injects
...
import { SVG3D, materialPresets } from "imagi3d";
import type { AnimationType, MaterialSettings } from "imagi3d";
...
function Download3DCapture({
  ...
  useEffect(() => {
    ...
    register3DExport((format, filename = "imagi3d") => {
