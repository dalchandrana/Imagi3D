...
Visual editor for designing 3D objects from SVGs, text, and pixel art. This is the app behind [imagi3d.design](https://imagi3d.design).
...
The web editor imports the engine as a workspace dependency (`"imagi3d": "file:../engine"`), so changes to the engine require a rebuild to be picked up.
