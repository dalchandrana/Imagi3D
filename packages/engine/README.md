...
![Imagi3D](https://raw.githubusercontent.com/dalchandrana/Imagi3D/main/.github/assets/demo.png)

The easiest way to turn SVGs into interactive React 3D components.

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/dalchandrana/Imagi3D/blob/main/LICENSE)
[![npm](https://img.shields.io/npm/v/imagi3d)](https://www.npmjs.com/package/imagi3d)
[![npm bundle size](https://img.shields.io/bundlephobia/minzip/imagi3d)](https://bundlephobia.com/package/imagi3d)
...
```tsx
const SVG3D = dynamic(
  () => import("imagi3d").then((m) => ({ default: m.SVG3D })),
  { ssr: false }
);
```
...
Design 3D objects visually and export embed code at [imagi3d.design](https://imagi3d.design).
...
MIT — [dalchandrana](https://github.com/dalchandrana/Imagi3D)
